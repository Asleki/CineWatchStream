...
function createMovieCard(item) {
    ...
    const content = `
        ...
        <div class="movie-details">
            ...
            <div class="btn-group">
                <a href="buy-ticket.html?hallId=hall.name&movieId=${item.id}" class="btn-buy">Buy Ticket</a>
                <a href="details.html?id=${item.id}&type=${mediaType}" class="btn-details">View Details</a>
            </div>
        </div>
    `;
...
async function renderCinemaGuide() {
    ...
    if (allMoviesAndShows.length > 0 && cinemaData.length > 0) {
        ...
        cinemaGuideContainer.innerHTML = '<p class="text-center text-red-500">Failed to load cinema guide data.</p>';
    }
