...
const initPage = async () => {
            ...
            // Corrected: Change 'movie_id' to 'movieId'
            const movieId = params.get('movieId'); 
            // Corrected: Change 'cinema_id' to 'hallId'
            const cinemaId = params.get('hallId'); 
            ...
            try {
                ...
                const cinemaResponse = await fetch('data/cinemaguide.json');
